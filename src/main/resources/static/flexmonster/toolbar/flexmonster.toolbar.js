FlexmonsterLoader.prototype.getToolbar = function () {
    ...
    var DefaultLabels = {
        ...
        CHARTS_MULTIPLE_DISABLED: "Multiple values does not apply to ",
        FORMAT: "Format",
    ...
    var FlexmonsterToolbar = function (pivotContainerId, pivot, isHTML5, width, labels) {
        ...
        dataProvider.push({
            ...
            menu: [
                ...
                {
                    title: Labels.CHARTS_BAR_STACK,
                    id: "fm-tab-charts-bar-stack",
                    handler: "chartsHandler",
                    args: "bar_stack",
                    flat: false
                },
                {
                    title: Labels.CHARTS_BAR_LINE,
                    id: "fm-tab-charts-bar-line",
                    handler: "chartsHandler",
                    args: "bar_line",
                    flat: false
                },
        ...
        self.checkChartMultipleMeasures = function () {
            var multiple = self.pivot.getOptions()['chartMultipleMeasures'];
            var node = document.getElementById("fm-tab-charts-multiple");
            if (node != null) self.disableMultyValues(self.pivot.getOptions()['chartType'], multiple, node);
        }
        ...
        self.showFormatCellsDialog = function () {
            var valuesDropDownChangeHandler = function () {
                ...
                isPercent.value = (formatVO.isPercent == true) ? true : false;
            }
            var applyHandler = function () {
                var formatVO = {};
                ...
                formatVO.isPercent = isPercent.value == "true" ? true : false;
            ...
            var isPercent = document.createElement("select");
            isPercent.options[0] = new Option(Labels.TRUE, true);
            isPercent.options[1] = new Option(Labels.FALSE, false);
            var tr = document.createElement("tr");
            var td = document.createElement("td");
            self.setText(td, Labels.IS_PERCENT);
            tr.appendChild(td);
            td = document.createElement("td");
            td.appendChild(isPercent);
            tr.appendChild(td);
            content.appendChild(tr);
        ...
        var ColorPicker = {
            ...
            color: function (target) {
                ...
                this.dropDownBox.appendChild(this.colorPreview);
                /* end */
