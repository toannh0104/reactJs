/* 
 * Flexmonster Pivot Table HTML5 v2.224 
 * http://flexmonster.com/ 
 * Date: 2016-10-24 12:41 
 */ 
...
function FlexMonster() {
	...
	this.setReport=function(object){try{this.componentObject.setReport(object)}catch(e){setTimeout(function(){if(this.componentObject)this.componentObject.setReport(object);},1000)}}
...
flexmonster._isHTML5Supported = function() {
	...
	var checkChrome = function() {
		return window.chrome && navigator.userAgent.match(/chrome.\d*/gi) ? getVersion(navigator.userAgent.match(/chrome.\d*/gi)[0]) >= 12 : true;
	}
	try {
